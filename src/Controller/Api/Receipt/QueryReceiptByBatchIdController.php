...
final class QueryReceiptByBatchIdController extends AbstractController
{
     ...
     */
    #[Route(path: '/api/wechat-pay-transfer/receipt/query/batch-id', name: 'api_wechat_pay_receipt_query_batch_id', methods: ['GET'])]
