...
final class ApplyReceiptByOutBatchNoController extends AbstractController
{
     ...
     */
    #[Route(path: '/api/wechat-pay-transfer/receipt/apply/out-batch-no', name: 'api_wechat_pay_receipt_apply_out_batch_no', methods: ['POST'])]
