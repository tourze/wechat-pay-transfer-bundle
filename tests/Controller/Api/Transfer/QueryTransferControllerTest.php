 ...
 * @internal
 */
#[CoversClass(QueryTransferController::class)]
#[RunTestsInSeparateProcesses]
final class QueryTransferControllerTest extends AbstractWebTestCase
{
    ...
    public function testQueryTransferMissingParams(): void
    {
    ...
    public function testMethodNotAllowed(string $method): void
    {
        ...
        try {
            $client->request($method, '/api/wechat-pay-transfer/transfer/query');
