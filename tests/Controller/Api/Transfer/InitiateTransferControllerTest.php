 ...
 * @internal
 */
#[CoversClass(InitiateTransferController::class)]
#[RunTestsInSeparateProcesses]
final class InitiateTransferControllerTest extends AbstractWebTestCase
{
    ...
    public function testInitiateTransferBatchNotFound(): void
    {
        $client = static::createClientWithDatabase();
        $this->loginAsAdmin($client);
        $payload = json_encode(['batch_id' => 'non_existent_id'], JSON_THROW_ON_ERROR);
        $client->request('POST', '/api/wechat-pay-transfer/transfer/initiate', [], [], [], $payload);
