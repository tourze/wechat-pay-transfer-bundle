 ...
 * @internal
 */
#[CoversClass(CancelTransferController::class)]
#[RunTestsInSeparateProcesses]
final class CancelTransferControllerTest extends AbstractWebTestCase
{
    ...
    public function testCancelTransferMissingBatchNo(): void
    {
        ...
        $client->request('POST', '/api/wechat-pay-transfer/transfer/cancel', [], [], [], $payload);
    ...
    public function testMethodNotAllowed(string $method): void
    {
        ...
        try {
            $client->request($method, '/api/wechat-pay-transfer/transfer/cancel');
