 ...
 * @internal
 */
#[CoversClass(ReceiptIndexController::class)]
#[RunTestsInSeparateProcesses]
final class ReceiptIndexControllerTest extends AbstractWebTestCase
{
    ...
    public function testReceiptIndexSuccess(): void
    {
        $client = static::createClientWithDatabase();
        $this->loginAsAdmin($client);
        $client->request('GET', '/api/wechat-pay-transfer/receipt');
        ...
        $this->assertSame('微信支付转账电子回单API', $data['message']);
    ...
    public function testMethodNotAllowed(string $method): void
    {
        ...
        try {
            $client->request($method, '/api/wechat-pay-transfer/receipt');
